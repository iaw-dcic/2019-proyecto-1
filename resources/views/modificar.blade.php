...
<div class="container">
        <form enctype= "multipart/form-data" action="/mis_post/modificar/?id_post={{$articulos->id}}" method="POST">    
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <span id="alertCategory" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="">
                                        <input type="text" class="form-control" name="id" id="txtCategoria" value="{{$articulos->id}}" required data-validation-required-message="Por favor introduzca su categoria.">
                                    </span>
                                    <br>
