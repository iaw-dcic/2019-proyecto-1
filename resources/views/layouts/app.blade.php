        ...
        <nav class="navbar sticky-top navbar-expand-md navbar-light navbar-laravel">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <a class="navbar-brand" href="/users">Usuarios</a>
                    <a class="navbar-brand mr-5" href="/listas/public">Listas</a>
                  


                    <form class="form-inline my-2 my-lg-0 ml-5"   method="GET"   action="/search">
                        <input class="form-control mr-sm-2" style="width: 300px;" type="search" name='search' placeholder="Buscar lista por nombre" aria-label="Search">
