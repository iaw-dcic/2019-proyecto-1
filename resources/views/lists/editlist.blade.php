            ...
            <div class="card-body">
                <form method="POST" action="{{ route('mylists.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="2" id="description" name="description{{ $errors->has('description') ? ' is-invalid' : '' }}">{{ $errors->has('description') ? old('description') : ($lista->description) }}</textarea>
