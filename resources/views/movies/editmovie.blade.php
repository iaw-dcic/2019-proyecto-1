...
@section('content')
	...
	<form method="POST" action="/lists/{{$list->id}}/movies/{{$movie->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="name" class="form-control" name="name" required autofocus value="{{$movie->name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="genre" type="name" class="form-control" name="genre" required autofocus value="{{$movie->genre}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="year" type="number" class="form-control" name="year" required autofocus min="0" max="9999" value="{{$movie->year}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control" name="description" required autofocus value="{{$movie->description}}">
                            </div>
                        </div>
