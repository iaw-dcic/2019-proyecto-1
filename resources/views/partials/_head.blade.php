<head>
  ...
  <!-- Google Font -->
  <link difer href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i,900,900i" rel="stylesheet">
  ...
  <link defer rel="stylesheet" href="{{ URL::asset('/css/fontawesome-all.css') }}">
	...
	<link defer href="//fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=cyrillic,latin-ext"
      rel="stylesheet">
  ...
  <!-- Faq -->
  <link defer rel="stylesheet" href="{{ URL::asset('/css/faq-custom.css') }}"> 
