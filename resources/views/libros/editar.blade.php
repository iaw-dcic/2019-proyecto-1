            ...
            <div class="col-md-8">
                ...
                <div class="card card-outline-secondary">
                    <div class="card-header">
                        <h4 class="mb-0">{{ __('Editar Libro') }}</h4>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('actualizar-libro', [$list_id, $book['id']] ) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="year" type="text" class="form-control" name="year" value="{{ $book['year'] }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a href="{{ route('show-lista', $list_id) }}" class="btn btn-secondary">Cancelar</a>
