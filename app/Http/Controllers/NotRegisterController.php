...
class NotRegisterController extends Controller
{
    public function loadCollection()
    {
        ...
        return view('/NotRegister/welcome',compact('collec'));
    }
    ...
    public function loadBooks($id)
    {
        ...
        return view('/NotRegister/loadbook', compact('books','collec'));
    }
    ...
    public function profile($id)
    {
        ...
        return view('/NotRegister/profile', compact('perfil','listasPublicas'));
    }
}
